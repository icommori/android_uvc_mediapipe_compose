...
fun OptionsScreen(
    ...
    val delegateDropdownExpanded = remember { mutableStateOf(false) }
    val mlModelDropdownExpanded = remember { mutableStateOf(false) }
    ...
    Column {
        ...
        MediaPipeBanner(
            ...
            camState = ObjectDetectorHelper.CAMSTATE_IDLE,
        )
        ...
        Row(
            ...
            IconButton(
                onClick = {
                    delegateDropdownExpanded.value = true
                },
            ) {
                Icon(
                ...
                DropdownMenu(
                    expanded = delegateDropdownExpanded.value,
                    onDismissRequest = { delegateDropdownExpanded.value = false },
                ) {
                    DropdownMenuItem(
                        text = { Text(text = "CPU") },
                        onClick = {
                            setDelegate(ObjectDetectorHelper.DELEGATE_CPU)
                            delegateDropdownExpanded.value = false
                        },
                    )
                    DropdownMenuItem(
                        text = { Text(text = "GPU") },
        ...
        Row(
            ...
            IconButton(
                onClick = {
                    mlModelDropdownExpanded.value = true
                },
            ) {
                Icon(
                    Icons.Filled.ArrowDropDown,
                ...
                DropdownMenu(
                    expanded = mlModelDropdownExpanded.value,
